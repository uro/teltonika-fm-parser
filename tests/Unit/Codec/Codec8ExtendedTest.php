...
class Codec8ExtendedTest extends TestCase
{
    ...
    protected function codecClass(): string
    {
     ...
     * @test
     */
    public function can_decode_io_element(): void
    {
    ...
    private function assertIoElement($ioElement): void
    {
    ...
    private function validIoElement(): string
    {
        return
